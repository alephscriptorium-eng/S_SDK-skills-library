...
`--save-exact` es obligatorio: sin él, npm guarda `"^0.6.0"` en
...
```bash
npm install @alephscript/skills-scriptorium@0.6.0
```
...
```json
"dependencies": {
  "@alephscript/skills-scriptorium": "0.6.0"
}
```
...
```bash
npm view @alephscript/skills-scriptorium@0.6.0 \
